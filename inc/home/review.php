            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="testimonial-content">
                        <div class="stars">★★★★★</div>
                        <p>
                            Booking my flight with Chase N Travel was fast, easy, and completely stress-free. They offer great deals on top airlines, so it was simple to find the perfect flight for my schedule. Everything went smoothly from booking to check-in, and I’ll definitely book with them again.
                        </p>
                ...
                <div class="carousel-item">
                    <div class="testimonial-content">
                        <div class="stars">★★★★★</div>
                        <p>
                            Chase N Travel makes booking flights so simple and reliable. I found better fares than anywhere else, and the flight options matched exactly what I needed. Their customer support was responsive and friendly, which made the entire process even better.
                        </p>
